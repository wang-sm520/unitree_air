...
UNITREE_MODEL_DIR = "/home/amiao/wsm/unitree_rl/unitree_model"
UNITREE_ROS_DIR = "/home/amiao/wsm/unitree_rl/unitree_ros"
...
ARM_NEW_4_CFG = UnitreeArticulationCfg(
   spawn=UnitreeUrdfFileCfg(
    ...
    # 关节名称列表 (用于部署到真机，共29个关节，其中2个固定)
    joint_sdk_names=[
        # 腰部 (3，其中 waist_roll 和 torso 是固定关节)
        "waist_yaw_joint",
        "waist_roll_joint",
        "torso_joint",
