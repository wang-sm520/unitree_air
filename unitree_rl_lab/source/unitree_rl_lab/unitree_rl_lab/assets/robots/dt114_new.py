...
DT114_URDF_DIR = "/home/hpf/wsm/unitree_rl/unitree_ros/robots/air_lj"
...
class DT114UrdfFileCfg(sim_utils.UrdfFileCfg):
    ...
    def replace_asset(self):
        ...
        urdf_src = f"{DT114_URDF_DIR}/urdf/air_lj.urdf"
...
_dt114_spawn_cfg = DT114UrdfFileCfg(
    asset_path=f"{DT114_URDF_DIR}/urdf/air_lj.urdf",  # Will be replaced
)
...
DT114_NEW_KP = [
    800.0,  # left_hip_pitch_joint
    800.0,  # left_hip_roll_joint
    800.0,   # left_hip_yaw_joint
    800.0,   # left_knee_joint
    200.0,   # left_ankle_pitch_joint
    200.0,   # left_ankle_roll_joint
    800.0,  # right_hip_pitch_joint
    800.0,  # right_hip_roll_joint
    800.0,   # right_hip_yaw_joint
    800.0,   # right_knee_joint
    200.0,   # right_ankle_pitch_joint
    200.0,   # right_ankle_roll_joint
]

DT114_NEW_KD = [
    10.0,  # left_hip_pitch_joint
    10.0,  # left_hip_roll_joint
    10.0,  # left_hip_yaw_joint
    10.0,  # left_knee_joint
    8.0,  # left_ankle_pitch_joint
    8.0,  # left_ankle_roll_joint
    10.0,  # right_hip_pitch_joint
    10.0,  # right_hip_roll_joint
    10.0,  # right_hip_yaw_joint
    10.0,  # right_knee_joint
